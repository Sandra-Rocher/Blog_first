  ...
  echo     ' 
                     <div class="col-sm-12 col-md-12 col-lg-5 mx-auto mb-5">
                        ...
                        <div class="card border border-info shadow-lg">
                            <p class="card-text mx-auto mt-3"><small class="text-info">Publié le '. $other_article["date_articles"] . ' par <span class="fw-bold"> '. $other_article["user_name"] . ' </span></small></p>
                            ...
                            <div class="card-body mx-auto">
                                ...
                                <a href="full_article.php" class="btn btn-info d-flex justify-content-center" >Voir l\'article complet</a>
                            </div>
                        </div>
                    </div>
             ';
